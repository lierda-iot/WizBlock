...
typedef enum {
    COMPANION_MOTION_FAILURE_NONE = 0,
    COMPANION_MOTION_FAILURE_IMU_PREPARATION,
    COMPANION_MOTION_FAILURE_OUTPUT_START,
    COMPANION_MOTION_FAILURE_FEEDBACK_STALL,
    COMPANION_MOTION_FAILURE_FEEDBACK_TIMEOUT,
    COMPANION_MOTION_FAILURE_STOP,
} companion_motion_failure_stage_t;
