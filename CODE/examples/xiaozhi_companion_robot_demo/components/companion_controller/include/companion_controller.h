...
typedef struct {
    ...
    network_manager_lifecycle_t network_lifecycle;
    network_manager_interface_t network_interface;
    network_manager_4g_phase_t network_phase;
...
esp_err_t companion_controller_set_capability(companion_capability_t capability,
                                               bool available,
                                               esp_err_t error);
void companion_controller_on_network_event(const network_manager_event_t *event,
                                           void *user_ctx);
