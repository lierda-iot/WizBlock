...
# xiaozhi_companion_robot_demo (EX-024)

Companion robot application demo.

## Status

- Public candidate status: `hold`
- Current verification: 部分链路已验证
- Evidence date: 2026-08-18
- Target: ESP32-S3 / ESP-IDF v5.5.4
- Main limitation: Held for credentials, assets, service boundary, and licensing review
