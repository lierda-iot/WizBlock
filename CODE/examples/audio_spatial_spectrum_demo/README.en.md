...
# audio_spatial_spectrum_demo (EX-023)

Dual-microphone spatial spectrum UI.

## Status

- Public candidate status: `publish-with-limitations`
- Current verification: 已验证
- Evidence date: 2026-07-22
- Target: ESP32-S3 / ESP-IDF v5.5.4
- Main limitation: Internal values are dBFS, not calibrated dB SPL
