...
# audio_dual_mic_doa_demo (EX-014)

Dual-microphone direction-of-arrival UI.

## Status

- Public candidate status: `publish-with-limitations`
- Current verification: 部分实机验证
- Evidence date: 2026-07-21
- Target: ESP32-S3 / ESP-IDF v5.5.4
- Main limitation: Angle range and soft-speech behavior remain unverified
